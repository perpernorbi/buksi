...
#define DIR_A_OUT_IO_MUX  PERIPHS_IO_MUX_GPIO2_U
#define DIR_A_OUT_IO_BIT  BIT2
#define DIR_A_OUT_IO_FUNC FUNC_GPIO2

#define DIR_B_OUT_IO_MUX  PERIPHS_IO_MUX_GPIO0_U
#define DIR_B_OUT_IO_BIT  BIT0
#define DIR_B_OUT_IO_FUNC FUNC_GPIO0
